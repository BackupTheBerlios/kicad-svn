...
BOARD * pcb = frame->m_Pcb;
	...
	pcb->m_BoundaryBox.m_Pos.x -= pcb->m_BoundaryBox.m_Pos.x % pas_route;
	pcb->m_BoundaryBox.m_Pos.y -= pcb->m_BoundaryBox.m_Pos.y % pas_route;
	...
	Nrows = pcb->m_BoundaryBox.m_Size.y / pas_route ;
	Ncols = pcb->m_BoundaryBox.m_Size.x / pas_route ;
