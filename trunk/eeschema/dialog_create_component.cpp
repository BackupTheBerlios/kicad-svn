...
////@begin WinEDA_CreateCmpDialog content construction
    // Generated by DialogBlocks, 01/14/06 18:22:55 (unregistered)

    WinEDA_CreateCmpDialog* itemDialog1 = this;

    this->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(), wxSWISS, wxNORMAL, wxNORMAL, FALSE, _T("")));
    ...
    m_Reference = new wxTextCtrl( itemDialog1, ID_TEXTCTRL, wxT("U"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    itemBoxSizer10->Add(itemStaticBoxSizer11, 0, wxALIGN_RIGHT|wxALL, 5);
    ...
    m_PartsCount = new wxRadioBox( itemDialog1, ID_RADIOBOX, _("Parts per package"), wxDefaultPosition, wxDefaultSize, 16, m_PartsCountStrings, 2, wxRA_SPECIFY_COLS );
    ...
    itemBoxSizer19->Add(itemStaticBoxSizer22, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_SetSkew = new wxSpinCtrl( itemDialog1, ID_SPINCTRL, wxT("40"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 40 );
